...
namespace Musical_Theatre.Controllers
{
    public class PerformancesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,HallName,Details")] Performance performance)
        {
            if (ModelState.IsValid)
            {
                Hall hall = _context.Halls.FirstOrDefault(h => h.Name == performance.HallName);
                performance.HallId = hall.Id;
            ...
            ViewData["HallName"] = new SelectList(_context.Halls, "Id", "Name", performance.HallId);
            return View(performance);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,HallId,HallName,Details")] Performance performance)
        {

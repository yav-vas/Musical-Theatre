namespace Musical_Theatre.Constants
{
    public class ErrorMessages
    {
        ...
        public const string EmptyPerformances = "There is no Performance with such an Id, please enter a valid Performance Id.";
        public const string EmptyPerformance = "There is no such a Performance, please first add a Performance.";
        ...
        public const string WrongSeatError = "There is no Seat with such a Row or Seat Number for this Performance. Please check the Hall Layout for both the size of the Hall and which Seats are taken and select a valid Seat.";
